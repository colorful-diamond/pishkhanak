...
@section('service_title', 'استعلام تاریخچه پلاک')

@section('submit_text', 'استعلام تاریخچه پلاک')
...
@section('other_services_section')
    ...
    <div class="mt-8 mb-6">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <a href="{{ route('services.show', ['slug1' => 'active-plates-list']) }}" 
               class="flex items-center justify-center p-4 bg-white border border-primary-normal rounded-xl hover:bg-primary-normal hover:text-white transition-all duration-300 group">
                <div class="text-center">
                    <svg class="w-7 h-7 text-primary-normal mx-auto mb-3 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v6a2 2 0 002 2h2m4 0h2a2 2 0 002-2V7a2 2 0 00-2-2h-2m-4 0V9m0 0h8"></path>
                    </svg>
        ...
        <div class="flex items-start">
            ...
            <div class="text-sm text-blue-700">
                ...
                <ul class="list-disc list-inside space-y-1">
                    <li>کد ملی باید متعلق به مالک پلاک باشد</li>
                    <li>شماره پلاک را به صورت کامل وارد کنید</li>
                    <li>تاریخچه نصب و جداکردن پلاک نمایش داده می‌شود</li>
                    <li>اطلاعات خودروهای قبلی با همین پلاک قابل مشاهده است</li>
                    <li>اطلاعات از سازمان راهداری دریافت می‌شود</li>
                </ul>
            </div>
        </div>
    </div>
