...
@section('service_title', 'استعلام عوارض آزادراهی')

@section('submit_text', 'استعلام عوارض')
...
@section('other_services_section')
    ...
    <div class="mt-8 mb-6">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <a href="{{ route('services.show', ['slug1' => 'traffic-vehicle-inquiry']) }}" 
               class="flex items-center justify-center p-4 bg-white border border-primary-normal rounded-xl hover:bg-primary-normal hover:text-white transition-all duration-300 group">
                <div class="text-center">
                    <svg class="w-7 h-7 text-primary-normal mx-auto mb-3 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17l3-3-3-3m4 6h-1m5-4a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span class="text-sm font-semibold text-primary-dark group-hover:text-white transition-colors">طرح ترافیک</span>
                </div>
            </a>
            ...
            <a href="{{ route('services.show', ['slug1' => 'plate-history-inquiry']) }}" 
               class="flex items-center justify-center p-4 bg-white border border-primary-normal rounded-xl hover:bg-primary-normal hover:text-white transition-all duration-300 group">
                <div class="text-center">
                    <svg class="w-7 h-7 text-primary-normal mx-auto mb-3 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span class="text-sm font-semibold text-primary-dark group-hover:text-white transition-colors">تاریخچه پلاک</span>
                </div>
            </a>
        </div>
    </div>
        ...
        <div class="flex items-start">
            ...
            <div class="text-sm text-blue-700">
                ...
                <ul class="list-disc list-inside space-y-1">
                    <li>فقط شماره پلاک کافی است</li>
                    <li>نتایج شامل تمام آزادراه‌های عبوری است</li>
                    <li>تاریخ و ساعت عبور نمایش داده می‌شود</li>
                    <li>امکان پرداخت آنلاین عوارض وجود دارد</li>
                    <li>اطلاعات از سازمان آزادراه‌ها دریافت می‌شود</li>
                </ul>
            </div>
        </div>
    </div>
