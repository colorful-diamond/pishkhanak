...
<div class="container mx-auto px-4 py-4">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <!-- Main Content - Custom Table Section -->
        <div class="lg:col-span-2">
            @include('front.services.custom.third-party-insurance-history.partials.preview-table', [
                'service' => $service,
        ...
        <!-- Sidebar - Custom Form Section -->
        <div class="lg:col-span-1">
            @include('front.services.custom.third-party-insurance-history.partials.preview-form', [
                'service' => $service,
