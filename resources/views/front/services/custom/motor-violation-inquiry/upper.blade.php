...
@section('service_title', 'استعلام خلافی موتورسیکلت')

@section('submit_text', 'استعلام خلافی موتور')
        ...
        <div class="flex items-start">
            ...
            <div class="text-sm text-blue-700">
                ...
                <ul class="list-disc list-inside space-y-1">
                    <li>شماره پلاک موتورسیکلت را به صورت کامل وارد کنید</li>
                    <li>کد ملی باید متعلق به مالک موتورسیکلت باشد</li>
                    <li>شماره موبایل جهت تایید هویت الزامی است</li>
                    <li>نتایج شامل تمام خلافی‌های قابل پرداخت است</li>
