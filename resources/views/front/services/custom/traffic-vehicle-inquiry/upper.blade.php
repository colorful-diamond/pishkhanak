...
@section('service_title', 'استعلام طرح ترافیک خودرو')

@section('submit_text', 'استعلام طرح ترافیک')
        ...
        <div class="flex items-start">
            ...
            <div class="text-sm text-blue-700">
                ...
                <ul class="list-disc list-inside space-y-1">
                    <li>استعلام طرح ترافیک شهر تهران</li>
                    <li>کد ملی باید متعلق به مالک خودرو باشد</li>
                    <li>شماره موبایل جهت تایید هویت الزامی است</li>
                    <li>نتایج شامل بدهی طرح ترافیک و وضعیت پرداخت است</li>
                    <li>امکان پرداخت آنلاین بدهی طرح ترافیک وجود دارد</li>
                </ul>
            </div>
        </div>
    </div>
