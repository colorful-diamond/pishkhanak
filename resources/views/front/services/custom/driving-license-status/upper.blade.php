...
@section('service_title', 'استعلام وضعیت گواهینامه')

@section('submit_text', 'استعلام وضعیت گواهینامه')

@section('form_fields')
    @include('front.services.custom.partials.mobile-national-fields')
@endsection
        ...
        <div class="flex items-start">
            ...
            <div class="text-sm text-blue-700">
                ...
                <ul class="list-disc list-inside space-y-1">
                    ...
                    <li>نتایج شامل تمام گواهینامه‌های صادر شده برای کد ملی است</li>
                    <li>شماره موبایل باید متعلق به صاحب گواهینامه باشد</li>
                    <li>نتایج فوری و آنلاین ارائه می‌شود</li>
                </ul>
            </div>
        </div>
    </div>
