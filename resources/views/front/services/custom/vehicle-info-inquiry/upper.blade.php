...
@section('service_title', 'استعلام اطلاعات خودرو')

@section('submit_text', 'استعلام اطلاعات')

@section('form_fields')
    @include('front.services.custom.partials.national-plate-fields')
@endsection
...
@section('other_services_section')
    ...
    <div class="mt-8 mb-6">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <!-- Row 2 -->
            <a href="{{ route('services.show', ['slug1' => 'third-party-insurance-history']) }}" 
               class="flex items-center justify-center p-4 bg-white border border-primary-normal rounded-xl hover:bg-primary-normal hover:text-white transition-all duration-300 group">
                <div class="text-center">
                    <svg class="w-7 h-7 text-primary-normal mx-auto mb-3 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span class="text-sm font-semibold text-primary-dark group-hover:text-white transition-colors">سوابق بیمه</span>
                </div>
            </a>
        ...
        <div class="flex items-start">
            ...
            <div class="text-sm text-blue-700">
                ...
                <ul class="list-disc list-inside space-y-1">
                    ...
                    <li>نتایج شامل اطلاعات فنی و بیمه خودرو است</li>
                    <li>اطلاعات شامل رنگ، مدل، و سال تولید خودرو است</li>
                    <li>اطلاعات از سازمان بیمه مرکزی دریافت می‌شود</li>
                </ul>
            </div>
        </div>
    </div>
