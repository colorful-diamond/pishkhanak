...
@section('service_title', 'بررسی و استعلام شماره شبا')


@section('submit_text', 'بررسی شماره شبا')
...
@section('bank_slider_section')
    @if(isset($banks) && count($banks) > 0)
        @include('front.components.bank-slider', ['banks' => $banks, 'serviceSlug' => 'iban-check'])
    @endif
@endsection 