<!-- Custom Cheque Inquiry Service Table Section -->
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    <!-- Service Header with Icon -->
    <div class="flex items-center mb-6">
        <div class="flex-shrink-0 w-12 h-12 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg flex items-center justify-center ml-3">
    ...
    <div class="bg-gradient-to-r from-emerald-50 to-green-50 border-2 border-emerald-200 rounded-xl p-6 mb-6">
        ...
        @php
            ...
            $checksApproved = $previewData['checks_summary']['approved'] ?? 3;
            $checksPending = $previewData['checks_summary']['pending'] ?? 1;
            $checksBounced = $previewData['checks_summary']['bounced'] ?? 0;
            $totalAmount = $previewData['total_amount'] ?? '35,000,000';
        @endphp
        ...
        <div class="bg-white rounded-lg p-4 mb-4 shadow-sm">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div class="flex justify-between items-center py-2">
                    <span class="text-sm text-gray-600">چک تصویب شده:</span>
                    <span class="text-sm font-bold text-green-600">**</span>
                </div>
                <div class="flex justify-between items-center py-2">
                    <span class="text-sm text-gray-600">چک در انتظار:</span>
                    <span class="text-sm font-bold text-yellow-600">**</span>
                </div>
                <div class="flex justify-between items-center py-2">
                    <span class="text-sm text-gray-600">چک برگشتی:</span>
                    <span class="text-sm font-bold text-red-600">**</span>
                </div>
                <div class="flex justify-between items-center py-2">
                    <span class="text-sm text-gray-600">مجموع مبلغ:</span>
                    <span class="text-sm font-bold text-emerald-600">*** ریال</span>
                </div>
            </div>
        </div>
    ...
    <div class="border-t border-gray-200 pt-4">
        <div class="flex items-center justify-between">
            ...
            <div class="text-left">
                <div class="text-lg font-bold text-emerald-600">{{ number_format($service->price) }} تومان</div>
            </div>
        </div>
    </div>
